    ...
    <div className="p-8 max-w-[1600px] mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <aside className="col-span-12 lg:col-span-3 xl:col-span-2 self-start">
          <div className="bg-surface-container-low rounded-xl p-5 sticky top-8 max-h-[calc(100vh-5rem)] overflow-y-auto custom-scrollbar border border-outline-variant/10 shadow-sm">
